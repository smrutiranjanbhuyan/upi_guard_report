...
\begin{itemize}
    ...
    \item \textbf{Simulated dataset:} The dataset used is from Kaggle and is described as ``realistic'' but is not actual UPI transaction data. Performance on real production data may differ from what we observed.
