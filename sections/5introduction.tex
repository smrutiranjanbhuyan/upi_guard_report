...
The dataset used is sourced from Kaggle and contains 100,000 simulated-but-realistic UPI transaction records designed to reflect patterns found in actual UPI fraud cases. The system is designed and tested in a batch training and real-time inference context -- it is not a streaming system, though the API layer could support streaming input with appropriate infrastructure.
